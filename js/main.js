let app = new Vue({
    ...
    data: {
        ...
        totalGames: parseInt(localStorage.getItem('sc2TotalGames')) ? parseInt(localStorage.getItem('sc2TotalGames')) : 0,
        questions: questions,
        results: results,
        resultRace: 'infested',
    },
    methods:{
        ...
        endGame(){
            this.totalGames = parseInt(this.totalGames);
            this.totalGames++;
            localStorage.setItem('sc2TotalGames', this.totalGames.toString())
            //Зерг
            if(this.score.zerg > this.score.terran && this.score.zerg > this.score.protoss && this.score.primal < 8 && Math.abs(this.score.protoss - this.score.zerg) > 3){
                this.goToResult('zerg')
                this.totalGame.zerg++
            } 
            // Изначальный
            else if(
                this.score.primal > this.score.protoss && this.score.primal > this.score.terran && this.score.primal == 8
            ){
            ...
            //Протосс
                ...
                this.score.protoss > this.score.zerg && this.score.protoss > this.score.terran && this.score.taldarim < 5 && Math.abs(this.score.protoss - this.score.zerg) > 3
            ){
            ...
            //Талдарим
                ...
                this.score.protoss > this.score.zerg && this.score.protoss > this.score.terran && this.score.taldarim == 5
            ){
            ...
            // Терран
                ...
                this.score.terran > this.score.zerg && this.score.terran > this.score.protoss
            ){
